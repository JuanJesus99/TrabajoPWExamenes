...
<?php
    ...
    $Seleccion_tema = $_POST['Seleccion_tema'];
    ...
    {
    ?>
        <FORM ACTION="Consulta_Rellenar_preguntas.php" METHOD="POST">
    <?php
        //$conexion_1 = mysqli_connect("localhost","Profesor1", "123456abc","examenes_online")  or die ("No se puede conectar con el servidor");
...
<?php
    ...
    else if(!isset($Seleccion_tema))
    {
        ?>

        <FORM ACTION="Rellenar_preguntas.php" METHOD="POST">
    <?php
        //$conexion_tema = mysqli_connect("localhost","Profesor1", "123456abc","examenes_online")  or die ("No se puede conectar con el servidor");
        ...
        print("<P>Seleccione le codigo del tema donde quiere insertar preguntas: </P>");
    ...
    <input type="submit" class="btn btn-primary ml-5" name="Seleccion_tema" value="Seleccion_tema">
    </FORM>
    </div>
    </div>
<?php
