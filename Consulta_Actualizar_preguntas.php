...
<?php
    ...
    {
    ?>
        <FORM ACTION="Consulta_Actualizar_preguntas.php" METHOD="POST">
    <?php
...
<?php
    ...
    <?php
        // $conexion_tema = mysqli_connect("localhost","cursophp", "","examenes_online")  or die ("No se puede conectar con el servidor");
        include('connect.php');
